...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tts_buttons_style = ("""
                                QPushButton{border:none;border-radius:15px;padding-left:10px}
...
### 1st Line
        ...
        #TTS
        self.btn_Tab_Tts = QPushButton('TTS',self.centralwidget)
        playIcon = QIcon();playIcon.addFile(u":/icons/play.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_Tab_Tts.setIcon(playIcon)
        self.btn_Tab_Tts.setMinimumSize(QSize(0, 30))
        self.btn_Tab_Tts.setMaximumSize(QSize(150, 16777215))
        self.btn_Tab_Tts.setFlat(True)
        self.btn_Tab_Tts.setFocusPolicy(Qt.NoFocus)
        self.btn_Tab_Tts.setStyleSheet("QPushButton{border:none}")
        self.hbox_Booth.addWidget(self.btn_Tab_Tts)
        ...
        self.cb_Booth.addItem('TTS_Test')
        self.cb_Booth.setItemData(9,font_10,Qt.FontRole)
...
### Playlist
        ...
        self.stack_Page_1_1 = QStackedWidget(self.page_1)
        self.gl_Stack_Page_1.addWidget(self.stack_Page_1_1, 1,1)

        #Grid Widget Playlist

        self.playlist_Page = QWidget()        

        self.gw_Playlist = QGridLayout(self.playlist_Page)
        #Playlist Table
        self.tw_Play_List_Table = QTableWidget(0,1,self.page_1)
        self.tw_Play_List_Table.setHorizontalHeaderItem(0, QTableWidgetItem('Title'))
        self.tw_Play_List_Table.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.tw_Play_List_Table.setSelectionBehavior(QAbstractItemView.SelectRows)
        self.tw_Play_List_Table.horizontalHeader().setStretchLastSection(True)
        self.tw_Play_List_Table.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
        self.tw_Play_List_Table.setMaximumSize(QSize(600, 16777215))
        #self.tw_Play_List_Table.setStyleSheet("QWidget{color:#ffffff}; QTableWidget{gridline-color: #ffffff};")
        self.tw_Play_List_Table.setFrameShape(QFrame.NoFrame)
        #self.tw_Play_List_Table.setFrameShadow(QFrame.Plain)
        self.tw_Play_List_Table.setStyleSheet("""
        ...
        self.gw_Playlist.addWidget(self.tw_Play_List_Table, 0, 0, 1, 1)
        ...
        self.stack_Page_1_1.addWidget(self.playlist_Page)


        #TTS
        self.tts_Page = QWidget()

        vbox_TTS = QVBoxLayout(self.tts_Page)

        self.qte_tts_text = QTextEdit(self.tts_Page)
        self.qte_tts_text.setStyleSheet("border:1px solid #EAECEE;")
        vbox_TTS.addWidget(self.qte_tts_text)

        hbox_TTS_Lang = QHBoxLayout()
        vbox_TTS.addLayout(hbox_TTS_Lang)

        self.btn_Tts_Lang = QButtonGroup()
        self.btn_Tts_Lang.setExclusive(True)

        self.btn_Tts_Lang_Style = ("""
                                QPushButton{border:none;border-radius:15px;padding-left:10px;color:black;}
                                QPushButton:hover{background-color:#D35400; color:white}
                                QPushButton:checked{padding-left:0px;background-color:#6E2C00;color:white}
                                """)

        self.btn_Tts_Kor = QPushButton('한국어',self.tts_Page)
        self.btn_Tts_Kor.setMinimumHeight(30)
        self.btn_Tts_Kor.setStyleSheet(self.btn_Tts_Lang_Style)
        self.btn_Tts_Kor.setCheckable(True)
        self.btn_Tts_Kor.setChecked(True)


        hbox_TTS_Lang.addWidget(self.btn_Tts_Kor)

        self.btn_Tts_Eng = QPushButton('영어',self.tts_Page)
        self.btn_Tts_Eng.setMinimumHeight(30)
        self.btn_Tts_Eng.setStyleSheet(self.btn_Tts_Lang_Style)
        self.btn_Tts_Eng.setCheckable(True)
        hbox_TTS_Lang.addWidget(self.btn_Tts_Eng)

        self.btn_Tts_Jap = QPushButton('일본어',self.tts_Page)
        self.btn_Tts_Jap.setMinimumHeight(30)
        self.btn_Tts_Jap.setStyleSheet(self.btn_Tts_Lang_Style)
        self.btn_Tts_Jap.setCheckable(True)
        hbox_TTS_Lang.addWidget(self.btn_Tts_Jap)

        self.btn_Tts_Chi = QPushButton('중국어',self.tts_Page)
        self.btn_Tts_Chi.setMinimumHeight(30)
        self.btn_Tts_Chi.setStyleSheet(self.btn_Tts_Lang_Style)
        self.btn_Tts_Chi.setCheckable(True)
        hbox_TTS_Lang.addWidget(self.btn_Tts_Chi)

        self.btn_Tts_Lang.addButton(self.btn_Tts_Kor,0)
        self.btn_Tts_Lang.addButton(self.btn_Tts_Eng,1)
        self.btn_Tts_Lang.addButton(self.btn_Tts_Jap,2)
        self.btn_Tts_Lang.addButton(self.btn_Tts_Chi,3)


        hbox_TTS = QHBoxLayout()
        vbox_TTS.addLayout(hbox_TTS)

        self.btn_Tts_Save_Text = QPushButton("저장하기", self.tts_Page)
        self.btn_Tts_Save_Text.setStyleSheet(self.tts_buttons_style)
        self.btn_Tts_Save_Text.setMinimumHeight(30)
        hbox_TTS.addWidget(self.btn_Tts_Save_Text)

        self.btn_Tts_Load_Text = QPushButton("불러오기", self.tts_Page)
        self.btn_Tts_Load_Text.setStyleSheet(self.tts_buttons_style)
        self.btn_Tts_Load_Text.setMinimumHeight(30)
        hbox_TTS.addWidget(self.btn_Tts_Load_Text)

        self.btn_Tts_preview = QPushButton("미리 듣기", self.tts_Page)
        self.btn_Tts_preview.setCheckable(True)        
        self.btn_Tts_preview.setStyleSheet("""
                                QPushButton{border:none;border-radius:15px;padding-left:10px}
                                QPushButton:hover{background-color:#A93226; color:white}
                                QPushButton:checked{padding-left:0px;background-color:#ccff99}
                                QPushButton:checked:hover{color:black;}
                                """)
        self.btn_Tts_preview.setMinimumHeight(30)
        hbox_TTS.addWidget(self.btn_Tts_preview)

        self.btn_Tts_Chime = QPushButton('챠임', self.tts_Page)
        self.btn_Tts_Chime.setCheckable(True)
        self.btn_Tts_Chime.setMaximumHeight(30)
        self.btn_Tts_Chime.setStyleSheet("""
                                ...
                                """)
        hbox_TTS.addWidget(self.btn_Tts_Chime)

        self.btn_Tts_Start = QPushButton("Text to Speech 송출하기",self.tts_Page)
        self.btn_Tts_Start.setCheckable(True)
        self.btn_Tts_Start.setMinimumHeight(30)
        self.btn_Tts_Start.setStyleSheet("""
                                QPushButton{border:none;border-radius:15px;padding-left:10px}
                                QPushButton:hover{background-color:#A93226; color:white}
                                QPushButton:checked{padding-left:0px;background-color:#ccff99}
                                QPushButton:checked:hover{color:black;}
                                """)
        vbox_TTS.addWidget(self.btn_Tts_Start)


        self.stack_Page_1_1.addWidget(self.tts_Page)
...
### Setup Page
        ...
        self.lbl_IP_Setup.setMaximumHeight(40)
        ...
        self.lbl_Tts_ID = QLabel('TTS ID',self.Ip_Setup_Widget)
        self.gw_IpSetup.addWidget(self.lbl_Tts_ID, 5, 0, 1, 1)

        self.qle_TTS_ID = QLineEdit(self.Ip_Setup_Widget)
        self.gw_IpSetup.addWidget(self.qle_TTS_ID, 5, 1, 1, 2)

        self.lbl_Tts_Secret = QLabel('TTS PASSWORD',self.Ip_Setup_Widget)
        self.gw_IpSetup.addWidget(self.lbl_Tts_Secret, 6, 0, 1, 1)

        self.qle_TTS_Secret = QLineEdit(self.Ip_Setup_Widget)
        self.gw_IpSetup.addWidget(self.qle_TTS_Secret, 6, 1, 1, 2)

        self.line_3 = QFrame(self.Ip_Setup_Widget)
        self.line_3.setFrameShape(QFrame.HLine)
        self.line_3.setFrameShadow(QFrame.Sunken)
        self.gw_IpSetup.addWidget(self.line_3, 7, 0, 1, 3)

        self.btn_Set_Ip = QPushButton('확인',self.Ip_Setup_Widget)
        self.gw_IpSetup.addWidget(self.btn_Set_Ip, 8, 1, 1, 1)

        self.btn_Set_Ip_Cancel = QPushButton('취소',self.Ip_Setup_Widget)
        self.gw_IpSetup.addWidget(self.btn_Set_Ip_Cancel, 8, 2, 1, 1)
...
### 3rd Line
    ###Player Control
        ...
        self.lbl_Vol_Value.setFont(font_10)
